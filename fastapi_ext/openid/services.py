...
from fastapi_ext.openid.password import hash_password, verify_password

from fastapi_ext.openid.repositories import (
...
class AuthenticationService:
    def __init__(
        self,
        identities: Annotated[IdentityRepository, Depends()],
        codes: Annotated[AuthorizationCodeRepository, Depends()],
    ) -> None:
